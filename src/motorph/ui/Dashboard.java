...
public class Dashboard extends javax.swing.JFrame {
    ...
    /**
     * Constructs the Dashboard window and sets up the default content (HomePanel).
     * Also links the side menu to the main content panel for navigation.
     */
    public Dashboard() {
        initComponents();
        
        // Link the menu component with the body panel so it can update the main display area.
        menu1.setMainPanel(body); // menu will access and replace the body panel
        
        // Show the HomePanel as the default view.
        body.removeAll();
        body.add(new HomePanel());
        body.revalidate();
        body.repaint();
    }
     ...
     * This method is auto-generated by the Form Editor and sets up the layout structure.
     */
